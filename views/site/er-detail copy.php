...
<div class="bg-slate-50 min-h-screen p-6 font-sans fade-up">
    <div class="max-w-7xl mx-auto mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div class="bg-white p-3 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col md:flex-row items-center gap-4">
                <div id="reportrange" class="flex items-center gap-4 px-5 py-3 cursor-pointer hover:bg-slate-50 rounded-2xl transition-all border border-transparent hover:border-slate-100">
                    <i data-lucide="calendar" class="w-6 h-6 text-hos-blue"></i>
                    <input type="text" id="date-range" class="bg-transparent border-none focus:ring-0 font-bold text-slate-700 cursor-pointer w-48 text-lg" readonly>
                    <i data-lucide="chevron-down" class="w-4 h-4 text-slate-400"></i>
                </div>
                
                <form id="date-form-er" method="get" action="<?= \yii\helpers\Url::to(['site/er-detail']) ?>" class="flex items-center gap-3">
                    <input type="hidden" name="r" value="site/er-detail">
                    <input type="hidden" id="start_date" name="start_date" value="<?= $start_date ?>">
                    <input type="hidden" id="end_date" name="end_date" value="<?= $end_date ?>">
                    
                    <button type="submit" class="bg-slate-900 text-white px-8 py-3.5 rounded-2xl font-bold shadow-lg hover:bg-slate-800 transition-all flex items-center gap-2 group">
